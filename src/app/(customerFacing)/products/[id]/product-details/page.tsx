...
function ProductDetailsPage( {allProduct}: {allProduct: Product}){
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
                ...
                <div>
                    ...
                    <Button className="w-full bg-green-800">
                        <Link href={`/products/${allProduct.id}/product-details/checkout/?amount=${allProduct.price}`} className="w-full">BUY NOW</Link>
                    </Button>
    ...
    <div className="mt-6">
        <h1 className="text-4xl font-bold mb-6">CUSTOMERS ALSO BUY </h1>
